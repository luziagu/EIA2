namespace Valley {
    ...
    function drawBackground(): void {
        ...
        gradient.addColorStop(1, "HSL(110, 68%, 30%)");
    ...
    function drawStreet (_position: Vector, _withBack: number, _withFront: number): void {
        console.log("Street");
        crc2.beginPath(); 
        crc2.moveTo(_position.x + _withBack / 2, _position.y); 
        crc2.lineTo(crc2.canvas.width / 2 + _withFront / 2, crc2.canvas.height); 
        crc2.lineTo(crc2.canvas.width / 2 - _withFront /2, crc2.canvas.height); 
        crc2.lineTo(_position.x - _withBack / 2, _position.y); 
        ...
        gradient.addColorStop(0.6, "HSLA(0, 0%, 0%, 0.8)"); 
        crc2.fillStyle = gradient; 
        crc2.fill(); 
    }
